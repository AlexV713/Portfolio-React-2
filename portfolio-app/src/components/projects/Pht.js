    ...
    <section className="work-sections">
        <div className="information">
            ...
            <div className="project-links">
                <a href="http://alejandrovalerio.me/Ace-in-the-Hole-Multisport-Events/projects/pht" target="_blank" rel="noreferrer" className="links">Live Preview <FaExternalLinkAlt /></a>
